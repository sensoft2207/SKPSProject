...
public class QuesPatientListTwoClick extends AppCompatActivity /*implements ActivityMenuPsychologist.OnBackClickListener*/ {
    ...
    QuestionaryClickTwoAdapter mAdapter;
    ...
    public QuesPatientListTwoClick() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cc = new CommanClass(QuesPatientListTwoClick.this);
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(QuesPatientListTwoClick.this));
    ...
    public void getQuestionnariesList() {
        ...
        pDialog = new ProgressDialog(QuesPatientListTwoClick.this);
        pDialog.setMessage(getString(R.string.please_wait));
        pDialog.show();

        StringRequest jsonObjReq = new StringRequest(Request.Method.POST, Const.ServiceType.QUESTION_TITLE,
                        ...
                        try {
                            ...
                            if (jsonObject.getString("status").equals("200")) {
                                ...
                                for (int i = 0; i < dataArray.length(); i++) {
                                    ...
                                    mAdapter = new QuestionaryClickTwoAdapter(list,R.layout.ques_three_item,QuesPatientListTwoClick.this);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("category_id", cc.loadPrefString("categoryid"));

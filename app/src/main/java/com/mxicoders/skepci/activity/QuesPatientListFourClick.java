...
import com.mxicoders.skepci.adapter.QuestionaryClickFourAdapter;
...
public class QuesPatientListFourClick extends AppCompatActivity /*implements ActivityMenuPsychologist.OnBackClickListener*/ {
    ...
    QuestionaryClickFourAdapter mAdapter;

    ArrayList<QuestionariesClickData> list;


    TextView tvDemo,tvCount,text_date;
    ...
    public QuesPatientListFourClick() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cc = new CommanClass(QuesPatientListFourClick.this);

        dem =  cc.loadPrefString("answer_que_name");
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(QuesPatientListFourClick.this));
    ...
    public void getQuestionnariesList() {
        ...
        pDialog = new ProgressDialog(QuesPatientListFourClick.this);
        pDialog.setMessage(getString(R.string.please_wait));
        pDialog.show();

        StringRequest jsonObjReq = new StringRequest(Request.Method.POST, Const.ServiceType.QUESTION_TITLE_ANSWED,
                        ...
                        try {
                            ...
                            if (jsonObject.getString("status").equals("200")) {
                                ...
                                for (int i = 0; i < dataArray.length(); i++) {
                                    ...
                                    mAdapter = new QuestionaryClickFourAdapter(list,R.layout.ques_three_item,QuesPatientListFourClick.this);
                                ...
                                text_date.setText(cc.loadPrefString("answer_createddate"));
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("task_id", cc.loadPrefString("answer_que_id"));

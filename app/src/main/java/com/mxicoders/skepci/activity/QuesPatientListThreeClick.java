...
import com.mxicoders.skepci.adapter.QuestionaryClickThreeAdapter;
import com.mxicoders.skepci.adapter.QuestionaryClickTwoAdapter;
...
public class QuesPatientListThreeClick extends AppCompatActivity /*implements ActivityMenuPsychologist.OnBackClickListener*/ {
    ...
    QuestionaryClickThreeAdapter mAdapter;
    ...
    public QuesPatientListThreeClick() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cc = new CommanClass(QuesPatientListThreeClick.this);

        dem =  cc.loadPrefString("assign_que_name");
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(QuesPatientListThreeClick.this));
    ...
    public void getQuestionnariesList() {
        ...
        pDialog = new ProgressDialog(QuesPatientListThreeClick.this);
        pDialog.setMessage(getString(R.string.please_wait));
        pDialog.show();

        StringRequest jsonObjReq = new StringRequest(Request.Method.POST, Const.ServiceType.QUESTION_TITLE_ASSIGNED,
                        ...
                        try {
                            ...
                            if (jsonObject.getString("status").equals("200")) {
                                ...
                                for (int i = 0; i < dataArray.length(); i++) {
                                    ...
                                    String createdDate = jsonObject1.getString("created_date");
                                    ...
                                    Date date = null;
                                    String finalCreated = null;

                                    try {
                                        date = inputFormat.parse(createdDate);
                                        finalCreated = outputFormat.format(date);
                                    ...
                                    model.setQue_id(jsonObject1.getString("task_id"));
                                    model.setQuestion_task_id(jsonObject1.getString("question_task_id"));
                                    model.setCreated_date(finalCreated);
                                    ...
                                    mAdapter = new QuestionaryClickThreeAdapter(list,R.layout.ques_three_item,QuesPatientListThreeClick.this);
                                    mRecyclerView.setAdapter(mAdapter);
                                }

                                Log.e("dd", String.valueOf(list.size()));
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("title_id", cc.loadPrefString("assign_que_id"));

...
public class TaskHisPatientMenuActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.fragment_patient_task_history);
        ...
        // Initialised
        adapter = new GridCellAdapter(TaskHisPatientMenuActivity.this,
        ...
        mRecyclerViewLastWeek.setLayoutManager(new LinearLayoutManager(TaskHisPatientMenuActivity.this));
        mRecyclerViewLastWeek.setItemAnimator(new DefaultItemAnimator());

        mRecyclerViewThisWeek.setLayoutManager(new LinearLayoutManager(TaskHisPatientMenuActivity.this));
...
/*
            ...
            if (colorselected == true){
                ...
                view.setBackgroundColor(Color.parseColor("#57A2DF"));
...
*/
    ...
    private void getTaskHistoryList(final String date_month_year) {
        ...
        pDialog = new ProgressDialog(TaskHisPatientMenuActivity.this);
        pDialog.setMessage(getString(R.string.please_wait));
        pDialog.show();

        StringRequest jsonObjReq = new StringRequest(Request.Method.POST, Const.ServiceType.TASK_HISTORY_PATIENT,
                        ...
                        try {
                            ...
                            if (jsonObject.getString("status").equals("200")) {
                                ...
                                if (listThisWeek.size() > 0) {
                                    mAdapterThisWeek = new TaskHistoryAdapter(listThisWeek, R.layout.todo_yesterday_rc_item, TaskHisPatientMenuActivity.this);
                                    mRecyclerViewThisWeek.setAdapter(mAdapterThisWeek);
                                }

                                if (listLastWeek.size() > 0) {
                                    mAdapterLastWeek = new TaskHistoryAdapter(listLastWeek, R.layout.todo_yesterday_rc_item, TaskHisPatientMenuActivity.this);

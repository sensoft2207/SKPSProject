...
import com.mxicoders.skepci.adapter.ArticlesClickAdapter;
 ...
 */
public class ArticlesTwoClickActivity extends AppCompatActivity {
    ...
    public static  ArticlesClickAdapter mAdapter;
    ArrayList<ArticleClickData> list;
    ArrayList<ArticleClickData> list2;
    ...
    public ArticlesTwoClickActivity() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cc = new CommanClass(ArticlesTwoClickActivity.this);
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(ArticlesTwoClickActivity.this));
    ...
    public void getArticleList() {
        ...
        pDialog = new ProgressDialog(ArticlesTwoClickActivity.this);
                            ...
                            if (jsonObject.getString("status").equals("200")) {
                                ...
                                for (int i = 0; i < dataArray.length(); i++) {
                                    ...
                                    if (dem.contentEquals(cname)) {
                                        ...
                                        model.setArticle_category_id(jsonObject1.getString("id"));
                                        ...
                                        Log.e("Article_category_id",jsonObject1.getString("id"));
                                    ...
                                    for (int m = 0; m < dataArrayTwo.length(); m++) {
                                        ...
                                        if (dem.contentEquals(cname)) {
                                            ...
                                            Log.e("Article_id",jsonObject2.getString("id"));

                                            list.add(model2);

                                            mAdapter = new ArticlesClickAdapter(list,R.layout.articles_click_item,ArticlesTwoClickActivity.this);

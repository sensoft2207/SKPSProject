...
import com.mxicoders.skepci.adapter.SendArticleSleepAdapter;
...
public class ArticleSleepPatientList extends AppCompatActivity {

    CommanClass cc;

    RecyclerView mRecyclerView;
    SendArticleSleepAdapter mAdapter;
    ...
    public ArticleSleepPatientList() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imgToolTwo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent narticle = new Intent(ArticleSleepPatientList.this, NewArticlesActivity.class);
    ...
    private void getArticleCategory() {
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.POST, Const.ServiceType.GET_ARTICLE_LIST,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getString("status").equals("200")) {
                                ...
                                mAdapter = new SendArticleSleepAdapter(data, R.layout.articles_adapter_item,ArticleSleepPatientList.this);
            ...
            public void onErrorResponse(VolleyError error) {
                pDialog.dismiss();
                AndyUtils.showToast(ArticleSleepPatientList.this,getString(R.string.ws_error));
            }
        }) {

...
/**
 * Created by mxi on 15/11/17.
 */

public class WebviewSleep  extends AppCompatActivity {
    ...
    private void popUpDialog() {
        ...
        dialog2 = new Dialog(WebviewSleep.this);
        ...
        tv_report.setText(getString(R.string.sleep));
    ...
    private void webViewStart(String start, String end, String patientID) {
        ...
        strUrlDateChange = "http://mbdbtechnology.com/projects/skepsi/ws/sleep_data/sleep_data/"+patientID.trim()+"/"+"/"+start.trim()+"/"+end.trim();
...
/*
    ...
    private void startWebView(String url) {
        ...
        wv_description.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                dialog=new ProgressDialog(WebviewSleep.this);
    ...
    private void noInternetAlert() {
        ...
        final Dialog dialog = new Dialog(WebviewSleep.this);

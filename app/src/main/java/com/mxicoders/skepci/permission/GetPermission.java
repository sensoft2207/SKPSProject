package com.mxicoders.skepci.permission;
...
import com.mxicoders.skepci.activity.SplashScreen;

/**
 * Created by mxi on 27/10/17.
 */
    ...
    public void onRequestPermissionsResult(final int requestCode, @NonNull final String[] permissions, @NonNull final int[] grantResults) {
        ...
        if (requestCode == REQUEST_PERMISSIONS) {
            if ((grantResults.length > 0) && (grantResults[0]+grantResults[1])
                ...
                Toast.makeText(GetPermission.this, "All Permission is required to use Skepsis", Toast.LENGTH_LONG).show();
                finish();
            }
        }
    }

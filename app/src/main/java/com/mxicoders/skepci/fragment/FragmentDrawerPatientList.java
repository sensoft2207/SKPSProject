...
public class FragmentDrawerPatientList extends Fragment {
    ...
    public FragmentDrawerPatientList() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        layout = inflater.inflate(R.layout.frag_nav_drawer_patient_menu, container, false);

...
public class RpdViewAdapter extends RecyclerView.Adapter<RpdViewAdapter.ViewHolder> {
    ...
    public RpdViewAdapter(List<RpdData> countries, int rowLayout, Context context) {

...
public class RpdViewAdapterThree extends RecyclerView.Adapter<RpdViewAdapterThree.ViewHolder> {
    ...
    public RpdViewAdapterThree(List<RpdData> countries, int rowLayout, Context context) {

...
import com.mxicoders.skepci.activity.SendArticleListSleep;
...
public class SendArticleSleepAdapter extends RecyclerView.Adapter<SendArticleSleepAdapter.ViewHolder> {
    ...
    public SendArticleSleepAdapter(List<ArticlesData> countries, int rowLayout, Context context) {
    ...
    private void doClick(int adapterPosition) {
        ...
        Intent article = new Intent(mContext, SendArticleListSleep.class);
        mContext.startActivity(article);


    }
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        public TextView Name,email,article_count,tv_category_like_count;

...
/**
 * Created by vishal on 4/4/18.
 */

public class NotesArchivedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NotesArchivedAdapter(Context context, List<ItemModelTwo> wallTalls) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
       ...
       /* if (viewType == ITEM_TYPE_RECYCLER_WIDTH) {
        ...
        return new NotesArchivedAdapter.ItemSwipeWithActionWidthNoSpringViewHolder(view);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof NotesArchivedAdapter.ItemViewHolderWithRecyclerWidth) {
            NotesArchivedAdapter.ItemViewHolderWithRecyclerWidth viewHolder = (NotesArchivedAdapter.ItemViewHolderWithRecyclerWidth) holder;
...
//                    doDelete(holder.getAdapterPosition());
        ...
        } else if (holder instanceof NotesArchivedAdapter.ItemSwipeWithActionWidthViewHolder) {
            NotesArchivedAdapter.ItemSwipeWithActionWidthViewHolder viewHolder = (NotesArchivedAdapter.ItemSwipeWithActionWidthViewHolder) holder;
...
*/
    ...
    private void initializeViews(ItemModelTwo model, final RecyclerView.ViewHolder holder, int position) {
        ...
        Glide.with(context)
                .load(imageUrl)
                .into(((NotesArchivedAdapter.ItemViewHolder)holder).imageView);


        ((NotesArchivedAdapter.ItemViewHolder)holder).name.setText(model.getName());
    }
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ItemViewHolder(View itemView) {
            ...
            ln_open.setVisibility(View.INVISIBLE);
    ...
    class ItemViewHolderWithRecyclerWidth extends NotesArchivedAdapter.ItemViewHolder {
    ...
    class ItemSwipeWithActionWidthViewHolder extends NotesArchivedAdapter.ItemViewHolder implements Extension {
    ...
    public class ItemSwipeWithActionWidthNoSpringViewHolder extends NotesArchivedAdapter.ItemSwipeWithActionWidthViewHolder implements Extension {

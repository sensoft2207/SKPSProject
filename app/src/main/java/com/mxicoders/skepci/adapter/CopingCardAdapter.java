...
public class CopingCardAdapter extends BaseAdapter {
    ...
    public CopingCardAdapter (Context context,List<CopingData> names,Activity activity){
...
//                DeleteCopingCard(cd.getId(),position);
                ...
                tvInfo.setText(context.getString(R.string.delete_coping));
